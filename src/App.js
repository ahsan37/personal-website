  ...
  return (
    <div className="App">
      ...
      <section className="App-intro">
        ...
        <p>
          I started to code after reading the Almanak of Naval Ravikant and learning about permissionless leverage. A month after reading that book I created a website that reached 150k+ users in 70+ countries. Now, I seek that leverage he talks about.
        </p>
        <p>
